...
test('registered user boots into A1-V3 financial flow',()=>{
  ...
  assert.ok(document.querySelector('.arise-v3-home')); assert.ok(document.querySelector('.arise-flow-stage')); assert.ok(document.querySelector('.arise-flow-material')); assert.equal(document.querySelectorAll('.arise-flow-grain circle').length,12); assert.equal(document.querySelectorAll('.arise-flow-drift,.arise-flow-particles').length,0); assert.ok(document.querySelector('.arise-remainder')); assert.ok(document.getElementById('homeIncome'));
