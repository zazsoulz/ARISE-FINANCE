...
function boot(){
  ...
  for(const path of ['financial-core.js','expense-reconciliation.js','financial-runtime.js','financial-integration.js','reserve-analytics.js','product-rules.js','arise-v3.js','analytics-engine.js','analytics-ui.js','history-inspector.js','financial-bootstrap.js'])file(context,path);
  return {dom,context};
}
