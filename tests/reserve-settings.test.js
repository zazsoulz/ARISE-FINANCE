...
function boot(){
  ...
  for(const path of ['financial-core.js','financial-runtime.js','financial-integration.js','reserve-analytics.js','product-rules.js','arise-v3.js','analytics-engine.js','analytics-ui.js','financial-bootstrap.js']) executeFile(context,path);
  return {dom,context};
}
